        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Kecamatan Cimanggis</li>
                </ol>
            </div>
        </div>
</section>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-md-6 col-sm-4 mb-2">
                                @if(Request::get('cari'))
                                <form action="{{ route('cimanggis.index') }}" method="get" class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <a href="{{route('cimanggis.index')}}" class="btn btn-danger ml-2">Kembali</a>
                                    </div>
                                </form>
                                @else
                                <form action="{{ route('cimanggis.index') }}" method="get" class="form-inline">
